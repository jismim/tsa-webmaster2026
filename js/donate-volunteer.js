const DATA = [
  ...
  // --- NEW ENTRIES ---
  {id:29, kind:"donate & volunteer", title:"Wharton Arts", desc:"Performing arts organization supporting music, theater, and arts education with volunteer and donation opportunities.", age:["adult","family","kids"], location:"berkeley-heights", services:["education"], link:"https://whartonarts.org/support-wharton-arts/", phone:"(908) 790-0700", address:"60 Locust Ave, Berkeley Heights, NJ 07922"},
  {id:30, kind:"donate & volunteer", colorSmile:true, title:"Color A Smile", desc:"Volunteers create cheerful drawings that are sent to isolated seniors, troops, and others who could use a smile.", age:["adult","family","teen","kids"], location:"morristown", services:["education"], link:"https://colorasmile.org/", phone:"(973) 540-9222", address:"164 Ridgedale Ave Unit 7, Morristown, NJ 07960"},
  {id:31, kind:"volunteer", title:"Morristown & Morris Township Library", desc:"Teen volunteer program supporting library programs and community services.", age:["teen","kids"], location:"morristown", services:["education"], link:"https://mmtlibrary.org/teens/teen-volunteers/", phone:"(973) 538-6161", address:"1 Miller Rd, Morristown, NJ 07960"},
  {id:32, kind:"volunteer", title:"Kinnelon Volunteer Animal Shelter", desc:"Community animal shelter offering volunteer opportunities for animal care and adoption support.", age:["adult","teen"], location:"kinnelon", services:["animals"], link:"https://www.kvasnj.org/", phone:"(973) 283-4120", address:"118 Kinnelon Rd, Kinnelon, NJ 07405"},
  {id:33, kind:"volunteer", title:"Butler Museum", desc:"Local history museum with volunteer opportunities supporting exhibits and community events.", age:["adult","teen","kids"], location:"butler", services:["education"], link:"https://www.butlerborough.com/cn/webpage.cfm?tpid=17694", phone:"(973) 838-7222", address:"Main St, Butler, NJ 07405"},
  {id:34, kind:"volunteer", title:"Whippany Railway Museum", desc:"Historic railway museum offering volunteer opportunities supporting preservation and education.", age:["adult","teen"], location:"whippany", services:["education"], link:"https://whippanyrailwaymuseum.net/", phone:"(973) 887-8177", address:"1 Railroad Plaza, Whippany, NJ 07981"},
  {id:35, kind:"volunteer", title:"Lincoln Park Conservatory", desc:"Botanical conservatory offering volunteer opportunities in horticulture and community programming.", age:["adult","teen","kids"], location:"chicago", services:["environment"], link:"https://www.lincolnparkconservancy.org/conservatory-reservations/", phone:"(773) 883-7275", address:"2391 N Stockton Dr, Chicago, IL 60614"},
  {id:36, kind:"donate & volunteer", title:"Riverdale Food Pantry", desc:"Municipal food pantry providing groceries to Riverdale residents in need.", age:["adult","family","kids"], location:"riverdale", services:["food"], link:"https://www.riverdalenj.gov/pages/riverdale-food-pantry", phone:"(973) 714-7141", address:"57 Loy Ave, Riverdale, NJ 07457"},
  {id:37, kind:"volunteer", title:"Roxbury Public Library", desc:"Public library offering volunteer opportunities supporting programs and community services.", age:["adult","teen","kids"], location:"succasunna", services:["education"], link:"https://www.roxburylibrary.org/", phone:"(973) 584-2400", address:"103 Main St, Succasunna, NJ 07876"},
  {id:38, kind:"volunteer", title:"Chester Mendham Food Pantry", desc:"Food pantry serving Chester and Mendham communities with volunteer-run grocery assistance.", age:["adult","family","kids"], location:"chester", services:["food"], link:"https://www.chestermendhamfp.com/volunteering.html", phone:"(862) 419-3373", address:"100 North Road, Chester, NJ 07930"},
  {id:39, kind:"donate", title:"Florham Park Education Foundation", desc:"Supports public education in Florham Park through fundraising and community donations.", age:["adult","family"], location:"florham-park", services:["education"], link:"https://www.fpefnj.org/ways-to-give", phone:"(646) 425-5030", address:"Florham Park, NJ 07932"},
  {id:40, kind:"donate", title:"NJ Chronic Fatigue Syndrome Association Inc.", desc:"Nonprofit supporting awareness, education, and advocacy for individuals living with chronic fatigue syndrome.", age:["adult","family","senior"], location:"florham-park", services:["medical"], link:"https://www.njcfsa.org/", phone:"", address:"Florham Park, NJ 07932"},
];
