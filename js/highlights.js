/* ============================================================
   ...
   Handles: hero load-in, scroll reveal, card rendering,
            modal open/close, footer year
============================================================ */
...
document.addEventListener('DOMContentLoaded', function () {
  ...
  function openModal(o, triggerEl) {
    ...
    var visitBtn = document.getElementById('modalVisitBtn');
    if (o.url) {
      visitBtn.href          = o.url;
    ...
    donateBtn.style.display = o.donateVolunteer ? 'inline-block' : 'none';
