...
const HIGHLIGHTS = [
    ...
    { week:"Week of Apr 13", name:"Loaves and Fishes Community Food Pantry",    location:"Boonton",              focus:"Faith-Based Hunger Relief",                why:"Serves river-town communities with reliable food access.",                                                      provides:["Weekly grocery assistance","Emergency meal requests"],                                                        giveback:["Donate non-perishables","Volunteer distribution support"] },
    { week:"Week of Apr 6",  name:"Hope One",                                location:"Morris County Mobile", focus:"Crisis & Homeless Outreach",               why:"Brings services directly to residents experiencing crisis or homelessness.",                                   provides:["On-site mental health support","Recovery referrals","Emergency resource connection", "Travels throughout locations in Morris County four times a week to service of people in need"],                        giveback:["Share resource information","Support outreach programs"] },
